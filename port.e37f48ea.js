...
document.querySelector(".nav__btn").addEventListener("click", function(e) {
    ...
    document.querySelector(".nav__container").dataset.active === "off" ? document.querySelector(".nav__container").dataset.active = "on" : document.querySelector(".nav__container").dataset.active = "off";
});
...
const animateFooter = function(entries, observer) {
    const [entry] = entries;
    if (entry.isIntersecting) footerCon.classList.add("scroll");
    else footerCon.classList.remove("scroll");
};
...
},{}]},["d8XZh","aenu9"], "aenu9", "parcelRequire2041")

//# sourceMappingURL=port.e37f48ea.js.map
